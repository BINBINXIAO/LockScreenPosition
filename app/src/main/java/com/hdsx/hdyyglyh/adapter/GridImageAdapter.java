...
public class GridImageAdapter extends RecyclerView.Adapter<GridImageAdapter.ViewHolder> {
    ...
    private boolean bIsSjIntent =false;
    ...
    public GridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener, boolean isImg) {
        this.context = context;
        mInflater = LayoutInflater.from(context);
        this.mOnAddPicClickListener = mOnAddPicClickListener;
        this.bIsSjIntent = isImg;
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if(bIsSjIntent){//应急上报查看数据逻辑
            ...
            if (getItemViewType(position) == TYPE_CAMERA) {
                viewHolder.mImg.setImageResource(R.drawable.icon_camera);
