...
public class EndSjDialog extends Dialog {

    public EndSjDialog(@NonNull Context context) {
        super(context);
    }

    public EndSjDialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);
    }

    protected EndSjDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.end_sj_dialog);
        initView();
    }
