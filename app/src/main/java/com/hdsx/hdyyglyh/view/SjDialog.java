...
public class SjDialog extends Dialog {


    private TextView tv_text;
    private Button btn;

    public SjDialog(@NonNull Context context) {
        super(context);
    }

    public SjDialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);

    }

    protected SjDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sj_dialog);
        initView();
    }
