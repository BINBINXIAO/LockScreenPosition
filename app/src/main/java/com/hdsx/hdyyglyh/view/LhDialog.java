...
public class LhDialog extends Dialog {
    ...
    public LhDialog(@NonNull Context context) {
        super(context);
    }

    public LhDialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);
    }

    protected LhDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lh_dialog);
        initView();
    }
